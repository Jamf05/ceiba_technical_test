...
import 'package:ceiba_technical_test/features/app/custom/widgets/modal_decoration_widget.dart';
                      ...
                      Row(
                        ...
                        children: [
                          ButtonWidget(
                              ...
                              text: "Aceptar",
                              textStyle: AppFonts.textStyleM15
                                  .copyWith(color: AppColors.whiteFirst),
              ...
              child: Column(
                ...
                children: [
                  if (showTitle) ...[
                    ...
                    Text(title ?? '', style: titleStyle ?? AppFonts.textStyleM17, textAlign: TextAlign.center,),
                    const SizedBox(
                      height: 18.11,
                    ),
                  ] else
